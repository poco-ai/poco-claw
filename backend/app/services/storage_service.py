...
class S3StorageService:
    def __init__(self) -> None:
        ...
        # 记录是否使用了自定义 public_endpoint
        self._use_custom_public_endpoint = public_endpoint != endpoint
    ...
    def presign_get(
        ...
        *,
        ...
        expires_in = expires_in or self.presign_expires
    ...
    def presign_get(
        ...
        *,
        ...
        try:
            ...
            # 如果使用自定义 public_endpoint，移除 URL 中的 bucket 路径
            if self._use_custom_public_endpoint:
                url = url.replace(f"/{self.bucket}/", "/", 1)
